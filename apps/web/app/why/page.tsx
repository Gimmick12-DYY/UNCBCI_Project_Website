  ...
  return (
    <div>
      ...
      <section className="bg-white border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-6 pt-10 md:pt-12 pb-16 md:pb-24">
          <figure className="rounded-2xl border border-gray-100 bg-white shadow-sm overflow-hidden mb-12 md:mb-16">
            <img
