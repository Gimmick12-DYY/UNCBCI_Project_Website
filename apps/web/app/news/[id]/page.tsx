  ...
  return (
    <article className="max-w-4xl mx-auto space-y-8">
      <header className="space-y-4 border-b border-gray-100 pb-8">
        <div className="flex items-center gap-3 text-sm font-medium text-unc mb-2">
        ...
        <div className="mt-12 pt-8 border-t border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {linkedPeople.map((person) => (
              <div key={person.id} className="flex items-center gap-3 p-3 border border-gray-100 rounded-xl hover:shadow-md transition-shadow bg-gray-50/50">
      ...
      <div className="flex justify-center pt-12">
        <Link href="/news" className="px-6 py-3 bg-white border border-gray-200 text-gray-600 rounded-full hover:border-unc hover:text-unc transition-all font-medium shadow-sm hover:shadow-md">
          &larr; Back to News
        </Link>
      </div>
    </article>
