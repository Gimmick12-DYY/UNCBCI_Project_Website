...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-unc-dark text-white rounded-2xl shadow-xl p-8 md:p-14 text-center md:text-left">
      ...
      <div className="relative z-10 container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
        ...
        <div className="hidden md:flex justify-center items-center relative">
          <div className="w-72 h-72 bg-gradient-to-tr from-unc to-purple-600 rounded-full opacity-15 blur-3xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-pulse"></div>
          <svg className="w-full max-w-md h-auto text-white" viewBox="0 0 420 300" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            <defs>
            ...
            {/* ── Sulci and gyri (internal folds) ────────────── */}
            {/* Central sulcus — deep, prominent */}
            ...
            {/* Pulsing rings on key electrodes */}
            ...
            {/* Frequency band readout (geeky data labels) */}
            ...
            {/* ── Animated scrolling EEG beneath the brain ─── */}
